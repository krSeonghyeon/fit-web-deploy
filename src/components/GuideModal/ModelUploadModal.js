        ...
        <div className="modal-slider" style={{ transform: `translateX(-${step * 100}%)` }}>
          ...
          <div className="modal-page">
            ...
            <ul className="modal-guideline-list">
              <li><span className="check-icon default">✓</span> 사진에는 의상만 있어야 해요</li>
              <li><span className="check-icon default">✓</span> 입고있는 사진은 사용할 수 없어요</li>
              <li><span className="check-icon default">✓</span> 팔이 접힌 의상은 사용할 수 없어요</li>
            </ul>
